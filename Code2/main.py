...
def parse_args():
    ...
    parser.add_argument('--data_path', default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data/emotic_pre', type=str, help='Path to preprocessed data npy files/ csv files')
    parser.add_argument('--experiment_path', default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data', type=str, required=True,
                        help='Path to save experiment files (results, models, logs)')
    parser.add_argument('--model_dir_name', default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data/models', type=str, help='Name of the directory to save models')
    parser.add_argument('--result_dir_name', type=str, default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/results',
                        help='Name of the directory to save results(predictions, labels mat files)')
    parser.add_argument('--log_dir_name', type=str, default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data/logs',
