...
def prepare_data(data_mat, data_path_src, save_dir, dataset_type='train', generate_npy=True, debug_mode=True):
    '''
    ...
    with open(csv_path, 'w') as csvfile:
        ...
        row = ['Index', 'Folder', 'Filename', 'Image Size', 'BBox', 'Categorical_Labels', 'Continuous_Labels', 'Gender',
               'Age']
...
def parse_args():
    ...
    parser.add_argument('--data_dir', default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data', type=str, required=False, help='Path to Emotic data and annotations')
    parser.add_argument('--save_dir_name', type=str, default='C:/Users/Daisy/Python_code/Emotions/pythonProject2/Data/emotic_pre',
    ...
    parser.add_argument('--debug_mode', action='store_true',
                        help='Debug mode. Will only save a small subset of the data')
    # Generate args
